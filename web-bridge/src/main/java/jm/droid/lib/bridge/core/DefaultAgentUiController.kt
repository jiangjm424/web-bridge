...
class DefaultAgentUiController(private val onMainFrameError: OnMainFrameError?) :
    ...
    override fun onMainFrameError(
        ...
        onMainFrameError?.invoke(true)
    }

    override fun onShowMainFrame() {
        super.onShowMainFrame()
        onMainFrameError?.invoke(false)
    }
}
typealias OnMainFrameError = (Boolean) -> Unit
